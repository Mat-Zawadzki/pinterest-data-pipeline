...
def run_infinite_post_data_loop():
    ...
    for i in range(11153):
        ...
        with engine.connect() as connection:
            ...
            run_post_to_topic_pin(payload_pin, headers)
            ...
            run_post_to_topic_geo(payload_geo, headers)
            ...
            run_post_to_topic_user(payload_user, headers)
...
def run_post_to_topic_pin(payload_pin, headers):
...
def run_post_to_topic_geo(payload_geo, headers):
...
def run_post_to_topic_user(payload_user, headers):
    invoke_url = "https://qsmuml0e2h.execute-api.us-east-1.amazonaws.com/test2/topics/12570a5c330b.user"
    response_usr = requests.request("POST", invoke_url, headers=headers, data=payload_user)
